    ...
    lessons: [
      ...
      },
      {
        ...
        sections: [
          ...
          {
            type: "say",
            html: "Haese 5D–5E is this same multiply in growth, decay, and compound interest. The algebra is still $u_n=u_1 r^{n-1}$. On Paper 2, the TI-84 CE tool has a How to use the GDC section for logs, the solver, and seq(.",
          },
        ],
      },
    ],
